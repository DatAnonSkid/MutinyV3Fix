...
CAM_ToThirdPersonFn CAM_ToThirdPerson;
CAM_ToFirstPersonFn CAM_ToFirstPerson;
...
void SetThirdPersonAngles()
{
	...
	*(QAngle*)((DWORD)LocalPlayer.Entity + 0xD0) = LocalPlayer.angAbsRotationAfterUpdatingClientSideAnimation;
	*(QAngle*)((DWORD)LocalPlayer.Entity + 0x128) = LocalPlayer.angAbsRotationAfterUpdatingClientSideAnimation;
	...
	{
		Interfaces::Prediction->SetLocalViewAngles(ShowRealAnglesChk.Checked ? LocalPlayer.LastRealEyeAngles : LocalPlayer.LastFakeEyeAngles);
	}
}
