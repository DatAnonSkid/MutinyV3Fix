...
using CAM_ToThirdPersonFn = void(__cdecl*)(void);
extern CAM_ToThirdPersonFn CAM_ToThirdPerson;
using CAM_ToFirstPersonFn = void(__cdecl*)(void);
extern CAM_ToFirstPersonFn CAM_ToFirstPerson;
...
using CreateIKFn = DWORD(__thiscall*)(void*);
extern CreateIKFn CreateIK;
