...
#include "C:/DeveloperFramework/Framework/Include/Frame-Include.h"
					 ...
					 )
{
	...
	case DLL_PROCESS_ATTACH:
	{
		...
		const char *UserAgentKeyOne = VMP_ENCDECSTRINGA("Rfwjkf4zTrXCytsxImIdeCEXM");
		const char *UserAgentKeyTwo = VMP_ENCDECSTRINGA("scIfltXrP8BV11EhN7G8o4GAC");
