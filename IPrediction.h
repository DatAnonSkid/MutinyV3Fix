...
public:
	...
	virtual void DylanUnknown1();
	virtual void DylanUnknown2();
...
public: //dylan changed from protected
	...
	virtual void			StartCommand(C_BasePlayer *player, CUserCmd *cmd);
	virtual void			FinishCommand(C_BasePlayer *player);
...
protected:
	...
	CHandle2< C_BaseEntity > m_hLastGround;
public: //dylan changed, was private
